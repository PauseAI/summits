...
We welcome contributions! See [METHODOLOGY.md](METHODOLOGY.md) for research guidelines.

1. Check [PROGRESS.md](PROGRESS.md) for countries needing research
2. Follow the template in `data/countries/_template.md`
...
This project is maintained by [PauseAI](https://pauseai.info). We encourage other AI governance organizations to contribute and use this resource.
